...
class AnimCurveToolbox(QtWidgets.QMainWindow):
	def __init__(self):
	...
	def __build_ui(self):
		...
		self.gb_create = QtWidgets.QGroupBox(self)
		self.gb_create.setGeometry(QtCore.QRect(10, 40, 171, 111))
		self.gb_create.setObjectName("gb_create")
		self.cb_create_type = QtWidgets.QComboBox(self.gb_create)
		...
		self.lbl_create_type = QtWidgets.QLabel(self.gb_create)
		...
		self.btn_edit_refresh = QtWidgets.QPushButton(self.gb_edit)
		...
		self.btn_edit_select = QtWidgets.QPushButton(self.gb_edit)
		...
		self.btn_edit_graph = QtWidgets.QPushButton(self.gb_edit)
		...
		self.lbl_website = QtWidgets.QLabel(self)
